...
class GajiController extends Controller
{
    ...
    public function import(Request $request)
    {
        ...
        // Variabel untuk menghitung jumlah baris yang berhasil diimpor
        $importedCount = 0;
        ...
        foreach ($rows as $index => $row) {
            ...
            // Tambahkan penghitung jumlah baris berhasil diimpor
            $importedCount++;
        }

        session()->flash('success', "Data bulan $request->month berhasil diimpor! Total pegawai/gaji yang diimpor: $importedCount");
